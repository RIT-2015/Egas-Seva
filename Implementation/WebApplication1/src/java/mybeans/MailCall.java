...
public class MailCall {
    ...
    private String smtpServ;
     ...
     public int sendMail(String to1,String subj,String message1)
     {
        try
        {
            ...
            msg.setHeader("E-gas Sewa", "egas.sewa2012@gmail.com" );
...
public static void main(String s[]){
    ...
    try{
	m.sendMail("shashi.sharma619@gmail.com","subj","You have been successfully registered to e-gas sewa");
    } 
    catch (Exception e) {	            
