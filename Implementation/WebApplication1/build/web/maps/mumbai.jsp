...
border: 1px solid #000;
            ...
            try
		{
			...
			Statement stmt = con.createStatement();
                        ResultSet rs=stmt.executeQuery("select count(*) from crce.distributor d, crce.geolocation g where lower(d.city) like 'mumbai' and d.d_id=g.d_id"); 
                            rs.next();
...
var options = {
zoom: 12,
center: new google.maps.LatLng(19.07753 ,	72.88244),
...
infowindow.open(map, marker);
        ...
        <h2 align="center">List of Distributors in Mumbai</h2>
