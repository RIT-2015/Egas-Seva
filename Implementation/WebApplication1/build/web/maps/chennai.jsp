       ...
       <%
            try
		{
			...
			Statement stmt = con.createStatement();
                        ResultSet rs=stmt.executeQuery("select count(*) from crce.distributor d, crce.geolocation g where lower(d.city) like 'chennai' and d.d_id=g.d_id"); 
                            rs.next();
...
<%
rs=stmt.executeQuery("select * from crce.distributor d, crce.geolocation g where lower(d.city) like 'chennai' and d.d_id=g.d_id");
int i=0; 
while(rs.next()){
%>
...
infowindow.open(map, marker);
        ...
        <h2 align="center">List of Distributors in Chennai</h2>
