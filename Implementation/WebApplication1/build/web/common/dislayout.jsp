...
<html>
    <head>
		...
		<script type="text/javascript">
			...
			var attributes = {};
			swfobject2.embedSWF("ChartsFX.swf", "DivChartsFX", "600", "400", "9.0.0", false, flashvars, params, attributes);
		</script>
        
<!--Distributor Left Menu -->
<script type="text/javascript" src="swfobject.js"></script>
		<script type="text/javascript">
			...
			params.wmode = "transparent";
			var attributes = {};
			swfobject.embedSWF("TextMenuFX.swf", "DivTextMenuFX", "240", "230", "9.0.0", false, flashvars, params, attributes);
		</script>
