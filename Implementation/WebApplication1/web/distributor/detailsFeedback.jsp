...
<html>
    ...
    <body>
        ...
        <div id="2" align="center"> 
            ...
            <s:form action="feedbackReply" namespace="/distributor" >
            ...
            <%--    <s:property value="email"/>       --%>
                ...
                <s:textfield name="fb.email" label="E-Mail" value="Copy customer's Email from above form" size="35" cssClass="validate[required] text-input" cssClass="validate[required,custom[email]] text-input"/>
