...
<tr>
    <td>
        ...
        <span  style=" margin-left: 75%; font-family: georgia; color: #0000ff"><b>
                <s:url id="url" action="NewCustomerDetails" namespace="/distributor"><s:param name="c_id" value="c_id"/></s:url><s:a href="%{url}"><img src="../resources/images/viewdetails.jpg"/></s:a>
                </b></span>
        </fieldset>
    </td>
</tr>
...
<tr>
    ...
    <td><fieldset style="background-color: #FFFFCC"><i><h4 align="center">No new Applications</h4></i></fieldset></td>
</tr>
<% }%>
</TABLE>
